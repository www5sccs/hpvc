...
#ifndef ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_PerformExplicitEulerTimeStep_H_
#define ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_PerformExplicitEulerTimeStep_H_
 ...
 */
class rotatingheatsource::expliciteuler::adapters::PerformExplicitEulerTimeStep {
  private:
  ...
  public:
    ...
    PerformExplicitEulerTimeStep();

    #if defined(SharedMemoryParallelisation)
    PerformExplicitEulerTimeStep(const PerformExplicitEulerTimeStep& masterThread);
    #endif

    virtual ~PerformExplicitEulerTimeStep();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const PerformExplicitEulerTimeStep& workerThread);
    #endif
