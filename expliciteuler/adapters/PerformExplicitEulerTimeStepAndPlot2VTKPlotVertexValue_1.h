...
#ifndef ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_1_H_
#define ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_1_H_
...
namespace rotatingheatsource { 
  namespace expliciteuler {
      namespace adapters {
        class PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_1;
      } 
}
}
 ...
 */
class rotatingheatsource::expliciteuler::adapters::PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_1 {
  private:
    /**
  ...
  public:
    ...
    PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_1();

    #if defined(SharedMemoryParallelisation)
    PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_1(const PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_1& masterThread);
    #endif

    virtual ~PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_1();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_1& workerThread);
    #endif
