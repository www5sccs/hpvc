...
#ifndef ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_Plot2VTKPlotVertexValue_0_H_
#define ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_Plot2VTKPlotVertexValue_0_H_
...
namespace rotatingheatsource { 
  namespace expliciteuler {
      namespace adapters {
        class Plot2VTKPlotVertexValue_0;
      } 
}
}
 ...
 */
class rotatingheatsource::expliciteuler::adapters::Plot2VTKPlotVertexValue_0 {
  private:
    /**
  ...
  public:
    ...
    Plot2VTKPlotVertexValue_0();

    #if defined(SharedMemoryParallelisation)
    Plot2VTKPlotVertexValue_0(const Plot2VTKPlotVertexValue_0& masterThread);
    #endif

    virtual ~Plot2VTKPlotVertexValue_0();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const Plot2VTKPlotVertexValue_0& workerThread);
    #endif
