...
#ifndef ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_SetupExperiment_H_
#define ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_SetupExperiment_H_
 ...
 */
class rotatingheatsource::expliciteuler::adapters::SetupExperiment {
  private:
    rotatingheatsource::expliciteuler::mappings::SetupExperiment _map2SetupExperiment;

    rotatingheatsource::expliciteuler::adapters::SetupExperiment2VTKGridVisualiser_0 _map2SetupExperiment2VTKGridVisualiser_0;
