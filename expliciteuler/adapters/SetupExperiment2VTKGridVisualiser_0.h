...
#ifndef ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_SetupExperiment2VTKGridVisualiser_0_H_
#define ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_SetupExperiment2VTKGridVisualiser_0_H_
...
namespace rotatingheatsource { 
  namespace expliciteuler {
      namespace adapters {
        class SetupExperiment2VTKGridVisualiser_0;
      } 
}
}
 ...
 */
class rotatingheatsource::expliciteuler::adapters::SetupExperiment2VTKGridVisualiser_0 {
  private:
    /**
  ...
  public:
    ...
    SetupExperiment2VTKGridVisualiser_0();

    #if defined(SharedMemoryParallelisation)
    SetupExperiment2VTKGridVisualiser_0(const SetupExperiment2VTKGridVisualiser_0& masterThread);
    #endif

    virtual ~SetupExperiment2VTKGridVisualiser_0();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const SetupExperiment2VTKGridVisualiser_0& workerThread);
    #endif
