...
#ifndef ROTATINGHEATSOURCE_EXPLICITEULER_MAPPINGS_ApplyRefineDeleteCriterion_H_
#define ROTATINGHEATSOURCE_EXPLICITEULER_MAPPINGS_ApplyRefineDeleteCriterion_H_
...
namespace rotatingheatsource { 
  namespace expliciteuler {
      namespace mappings {
        class ApplyRefineDeleteCriterion;
      } 
}
}
 ...
 */
class rotatingheatsource::expliciteuler::mappings::ApplyRefineDeleteCriterion {
  private:
    /**
    ...
    matrixfree::solver::SurplusCalculator  _surplusCalculator;
  ...
  public:
     ...
     */
    ApplyRefineDeleteCriterion(const ApplyRefineDeleteCriterion& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~ApplyRefineDeleteCriterion();
     ...
     */   
    void mergeWithWorkerThread(const ApplyRefineDeleteCriterion& workerThread);
    #endif
 ...
 \endcode
     ...
     *
     * @see ApplyRefineDeleteCriterion()
     */
    void beginIteration(
