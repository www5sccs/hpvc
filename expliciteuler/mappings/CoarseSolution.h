...
#ifndef ROTATINGHEATSOURCE_EXPLICITEULER_MAPPINGS_CoarseSolution_H_
#define ROTATINGHEATSOURCE_EXPLICITEULER_MAPPINGS_CoarseSolution_H_
 ...
 */
class rotatingheatsource::expliciteuler::mappings::CoarseSolution {
  private:
    /**
  ...
  public:
     ...
     */
    CoarseSolution(const CoarseSolution& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~CoarseSolution();
     ...
     */   
    void mergeWithWorkerThread(const CoarseSolution& workerThread);
    #endif
