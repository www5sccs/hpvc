...
#ifndef ROTATINGHEATSOURCE_EXPLICITEULER_MAPPINGS_SetupExperiment_H_
#define ROTATINGHEATSOURCE_EXPLICITEULER_MAPPINGS_SetupExperiment_H_
 ...
 */
class rotatingheatsource::expliciteuler::mappings::SetupExperiment {
  private:
    /**
