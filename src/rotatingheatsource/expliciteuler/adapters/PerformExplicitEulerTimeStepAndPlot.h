...
#ifndef ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_PerformExplicitEulerTimeStepAndPlot_H_
#define ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_PerformExplicitEulerTimeStepAndPlot_H_
...
namespace rotatingheatsource { 
  namespace expliciteuler {
      namespace adapters {
        class PerformExplicitEulerTimeStepAndPlot;
      } 
}
}
 ...
 */
class rotatingheatsource::expliciteuler::adapters::PerformExplicitEulerTimeStepAndPlot {
  private:
    rotatingheatsource::expliciteuler::mappings::PerformExplicitEulerTimeStep _map2PerformExplicitEulerTimeStep;
    rotatingheatsource::expliciteuler::mappings::CoarseSolution _map2CoarseSolution;
    rotatingheatsource::expliciteuler::mappings::ApplyRefineDeleteCriterion _map2ApplyRefineDeleteCriterion;

    rotatingheatsource::expliciteuler::adapters::PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_0 _map2PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_0;
    rotatingheatsource::expliciteuler::adapters::PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_1 _map2PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_1;
  ...
  public:
    ...
    PerformExplicitEulerTimeStepAndPlot();

    #if defined(SharedMemoryParallelisation)
    PerformExplicitEulerTimeStepAndPlot(const PerformExplicitEulerTimeStepAndPlot& masterThread);
    #endif

    virtual ~PerformExplicitEulerTimeStepAndPlot();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const PerformExplicitEulerTimeStepAndPlot& workerThread);
    #endif
