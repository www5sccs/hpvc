...
#ifndef ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_0_H_
#define ROTATINGHEATSOURCE_EXPLICITEULER_ADAPTERS_PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_0_H_
...
namespace rotatingheatsource { 
  namespace expliciteuler {
      namespace adapters {
        class PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_0;
      } 
}
}
 ...
 *
 * solution   filename
 * getTemperature   getter for vertex value (without brackets)
 * u   Legend title
 *
 * @author Tobias Weinzierl
 * @version $Revision: 1.10 $
 */
class rotatingheatsource::expliciteuler::adapters::PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_0 {
  private:
    /**
  ...
  public:
    ...
    PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_0();

    #if defined(SharedMemoryParallelisation)
    PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_0(const PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_0& masterThread);
    #endif

    virtual ~PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_0();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const PerformExplicitEulerTimeStepAndPlot2VTKPlotVertexValue_0& workerThread);
    #endif
