...
#ifndef ROTATINGHEATSOURCE_EXPLICITEULER_MAPPINGS_PerformExplicitEulerTimeStep_H_
#define ROTATINGHEATSOURCE_EXPLICITEULER_MAPPINGS_PerformExplicitEulerTimeStep_H_
 ...
 */
class rotatingheatsource::expliciteuler::mappings::PerformExplicitEulerTimeStep {
  private:
    /**
    ...
    rotatingheatsource::Solver       _solver;
    matrixfree::solver::Multigrid    _multigrid;

    // @todo Query
    queries::Query*                    _currentQuery;
    int _heapId;
 ...
 \endcode
    ...
    void mergeAnswer(std::vector<queries::records::Answer>& masterAnswer,
    		std::vector<queries::records::Answer> workerAnswer);
    #endif
     ...
     *
     * @see PerformExplicitEulerTimeStep()
     */
    void beginIteration(
