#ifndef _ROTATINGHEATSOURCE_EXPLICITEULER_RECORDS_REPOSITORYSTATE_H
#define _ROTATINGHEATSOURCE_EXPLICITEULER_RECORDS_REPOSITORYSTATE_H
...
class rotatingheatsource::expliciteuler::records::RepositoryState { 
   ...
   public:
      ...
      typedef rotatingheatsource::expliciteuler::records::RepositoryStatePacked Packed;
      
      enum Action {
         WriteCheckpoint = 0, ReadCheckpoint = 1, Terminate = 2, UseAdapterSetupExperiment = 3, UseAdapterPerformExplicitEulerTimeStep = 4, UseAdapterPerformExplicitEulerTimeStepAndPlot = 5, UseAdapterPlot = 6
      };
 ...
 #endif 
 {
   ...
   class rotatingheatsource::expliciteuler::records::RepositoryStatePacked { 
      ...
      public:
         ...
         typedef rotatingheatsource::expliciteuler::records::RepositoryState::Action Action;
